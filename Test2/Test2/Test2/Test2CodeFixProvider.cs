...
namespace Test2
{
    ...
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(Test2CodeFixProvider)), Shared]
    public class Test2CodeFixProvider : CodeFixProvider
    {
        private const string title = "Make constant";

        public sealed override ImmutableArray<string> FixableDiagnosticIds
        {
            get { return ImmutableArray.Create(Test2Analyzer.DiagnosticId); }
        }
        ...
        private async Task<Document> MakeConstantAsync(Document contextDocument, LocalDeclarationStatementSyntax declaration, CancellationToken cancellationToken)
        {
