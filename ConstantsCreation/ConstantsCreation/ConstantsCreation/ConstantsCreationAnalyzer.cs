...
namespace ConstantsCreation
{
    ...
    public class ConstantsCreationAnalyzer : DiagnosticAnalyzer
    {
        public const string DiagnosticId = "ConstantsCreation";
        ...
        private void AnalizeNode(SyntaxNodeAnalysisContext context)
        {
